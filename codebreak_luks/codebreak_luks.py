...
user = os.getlogin()
luks_drive = input(f"{print_question} LUKS master drive: ")
luks_type = input(f"\n(Use 'U' if it's unknown)\n{print_question} LUKS type (1, 2, or U): ")
print(f"\n({print_alert} This is a slow process - do not quit as it may cause corruption in the LUKS system)")
...
# Attack method
attack_type = input(f"\n{print_question} What type of attack do you want (Singular or Hashcat): ")
